...
df_oldids['replace+2']=df_oldids['replace1'].str.replace('(.*NP_)','')
df_oldids['replace+3']=df_oldids['replace+2'].str.replace('(.*NC_)','')
df_oldids['replace+both']=df_oldids['replace+3'].str.replace('(.*YP_)','')
